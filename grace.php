...
<html lang="en">
  <head>
    ...
    <title>Written By Larry - The Philosophical Problem of Grace</title>
    <!--Favicon-->
    <link
      rel="shortcut icon"
    ...
    <section class="nima-sec">
      <div class="container">
        <h3 class="text-center pb-4">
          The Philosophical Problem of Grace
        </h3>
...
intricacies in the conclusions that could be drawn by assigning a deed to be an act of grace.</p>
        ...
        <p>
          ResearchGate, unknown, 3 Dec. 2019, <a href="www.researchgate.net/publication/">www.researchgate.net/publication/</a>
        </p>
        <p>337706835_Grace_of_God_A_Phenomenological_Inquiry. Accessed 30 May 2022.</p>
      </div>
    </section>
